...
foods.forEach(function(arr){
  arr.calories = (arr.carbs * 4) + (arr.protein * 4) + (arr.fat * 9)
})
...
let saleProducts = products.map(function(arr){
   arr.price = arr.price * .75
   return arr
})
...
let ellensInfo = {...helensInfo, email:'ellen@email.com', name:'Ellen'}
